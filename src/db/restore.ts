 ...
 */
const restore_data = ( id_selected: string, name_selected: string ) => {
  // あとで実装
  ...
  if ( is_id && is_name && is_year ) {
    ...
    range_1.setValues( [
      json_obj_for_read[ id_selected ][ "name" ][ name_selected ][ "year" ][ year_selected ][ "data" ][ key_list[ 0 ] ],//["100000000","2","3","uiui","5","6","7","8","9","10","11",""]
    ...
    // 完了通知
    const message: string = "復元が完了しました。";
